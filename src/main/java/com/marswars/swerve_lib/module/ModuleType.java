...
public class ModuleType {
    ...
    private static final ModuleType[] ALL_TYPES = {
        ...
        // TSN
        new ModuleType("TSN-P12-S18", 24, 6.74, false),
        new ModuleType("TSN-P13-S18", 24, 6.23, false),
        new ModuleType("TSN-P14-S18", 24, 5.79, false),
        new ModuleType("TSN-P12-S16", 24, 6.00, false),
        new ModuleType("TSN-P13-S16", 24, 5.54, false),
        new ModuleType("TSN-P14-S16", 24, 5.14, false),
    };
